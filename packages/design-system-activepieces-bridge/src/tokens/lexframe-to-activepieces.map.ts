...
export const lexFrameToActivepiecesTokenMap = [
  ...
  map("color.apPrimary", "--lf-ap-primary", "color", "Activepieces-like navigation, Canvas tabs, AP selected state", "Canvas-adjacent controls use the stock AP accent."),
  map("color.apPrimary.hover", "--lf-ap-primary-hover", "color", "Activepieces-like navigation hover and selected controls", "AP accent hover remains separate from LexFrame domain blue."),
  map("color.domainPrimary", "--lf-domain-primary", "color", "Legal-domain primary actions", "LexFrame blue remains available for legal workflow actions."),
  map("color.domainPrimary.hover", "--lf-domain-primary-hover", "color", "Legal-domain primary action hover", "Domain action hover remains tied to LexFrame blue."),
