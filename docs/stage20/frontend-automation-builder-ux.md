# Frontend Automation Builder UX

Generated by `scripts/stage20/gates.mjs`.

Reference check:
- assistant-ui tool cards/action rendering, Chatbot UI composer shell, LibreChat tool UX and AnythingLLM workspace UX were reviewed; Stage 20 UI is clean-room and backend-controlled.
