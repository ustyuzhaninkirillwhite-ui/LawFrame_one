...
| --- | --- | --- | ---: |
P0 | PASS | `docs/stage17/17.1/ADR-17.1-local-owner-key-vault.md` | 1703
P0 | PASS | `docs/stage17/17.1/ADR-17.2-activepieces-design-unification.md` | 1600
P1 | PASS | `docs/stage17/17.1/source-inventory.md` | 2550
P0 | PASS | `docs/stage17/secret-surface-inventory.md` | 1061
P1 | PASS | `docs/stage17/localization-coverage-report.md` | 1304
P1 | PASS | `docs/stage17/debranding-coverage-report.md` | 1292
P1 | PASS | `docs/stage17/design-token-mapping.md` | 853
P1 | PASS | `docs/stage17/functionality-preservation-report.md` | 796
...
P0 | PASS | `docs/stage17/ADR-stage17-canvas-strategy.md` | 2198
P1 | PASS | `docs/stage17/stage17-known-limitations.md` | 1133
P1 | PASS | `docs/stage17/stage17-risk-register.md` | 1529
P0 | PASS | `docs/stage17/stage17-evidence-index.md` | 1747
P1 | PASS | `docs/stage17/localization-runtime-audit.md` | 1220
P0 | PASS | `docs/stage17/localization-flicker-hardening.md` | 1181
P1 | PASS | `docs/stage17/debranding-runtime-audit.md` | 887
...
P0 | PASS | `artifacts/stage17/localization-flicker-evidence.json` | 1720
P0 | PASS | `artifacts/stage17/debranding-icon-evidence.json` | 1479
P0 | PASS | `artifacts/stage17/pieces-inventory.json` | 802758
P0 | PASS | `artifacts/stage17/pieces-build-report.json` | 1426
P0 | PASS | `artifacts/stage17/pieces-sync-report.json` | 627
P0 | PASS | `artifacts/stage17/pieces-localization-report.json` | 1096
P1 | PASS | `scripts/secrets/init-local-keys.ps1` | 1265
