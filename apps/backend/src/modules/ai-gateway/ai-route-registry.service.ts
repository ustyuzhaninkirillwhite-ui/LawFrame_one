...
export class AiModelRouteRegistryService {
  ...
  listRoutes(): readonly AiModelRoute[] {
    ...
    return [
      ...
      {
        routeCode: 'document_generation_assist',
        providerConnectionId,
        providerCode,
        model: defaultModel,
        supportsStreaming: true,
      ...
      {
        routeCode: 'chat_title_generation',
        providerConnectionId,
        providerCode,
        model: defaultModel,
      ...
      {
        routeCode: 'automation_blueprint',
        providerConnectionId: 'stage20_reserved_owner_route',
        providerCode: 'openai',
        model: 'gpt-5.5',
        supportsStreaming: true,
      ...
      {
        routeCode: 'workflow_patch_generation',
        providerConnectionId: 'stage20_reserved_owner_route',
        providerCode: 'openai',
        model: 'gpt-5.5',
        supportsStreaming: true,
      ...
      {
        routeCode: 'automation_tool_reasoning',
        providerConnectionId: 'stage20_reserved_owner_route',
        providerCode: 'openai',
        model: 'gpt-5.5',
        supportsStreaming: true,
