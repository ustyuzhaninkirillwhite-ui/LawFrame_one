...
if (
    ...
    /process\.env\.(SUPABASE_SECRET_KEY|SUPABASE_DB_URL|DATABASE_URL|ACTIVEPIECES_API_KEY|ACTIVEPIECES_API_KEY_SECRET_REF|ACTIVEPIECES_SIGNING_PRIVATE_KEY|ACTIVEPIECES_SIGNING_PRIVATE_KEY_SECRET_REF|LEXFRAME_LOCAL_KEYS_FILE|XAI_API_KEY|COMETAPI_API_KEY)/.test(
      content,
    )
  ) {
